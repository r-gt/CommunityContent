...
__if_2031_start:
  mov R0, [BP+2]
  fge R0, 1.000000
  jt R0, __LogicalOr_ShortCircuit_2043
  mov R1, [BP+3]
  ieq R1, 0
  jf R1, __LogicalAnd_ShortCircuit_2040
  mov R2, [BP+4]
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_2040:
  or R0, R1
__LogicalOr_ShortCircuit_2043:
  jf R0, __if_2031_end
  mov R0, 1.000000
  jmp __function_ease_return
__if_2031_end:
...
__if_2046_start:
  mov R0, [BP+2]
  flt R0, 0.500000
  jt R0, __LogicalOr_ShortCircuit_2051
  mov R1, [BP+4]
  ieq R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_2051:
  jf R0, __if_2046_end
__if_2055_start:
  mov R0, [BP+4]
  ieq R0, 0
  jf R0, __if_2055_else
  mov R0, [BP+2]
  mov [BP-1], R0
  jmp __if_2055_end
__if_2055_else:
...
__if_2085_start:
  ...
  mov R1, 2
  ieq R1, R0
  jt R1, __switch_2090_case_2
  mov R1, 3
  ieq R1, R0
  jt R1, __switch_2090_case_3
  mov R1, 4
  ieq R1, R0
  jt R1, __switch_2090_case_4
  mov R1, 5
  ieq R1, R0
  jt R1, __switch_2090_case_5
  mov R1, 6
  ieq R1, R0
  jt R1, __switch_2090_case_6
  jmp __switch_2090_end
__switch_2090_case_2:
  mov R2, [BP-1]
  fmul R2, 3.141593
  fdiv R2, 2.000000
  mov [SP], R2
...
__if_2171_start:
  mov R0, [BP+2]
  fge R0, 0.500000
  jt R0, __LogicalOr_ShortCircuit_2176
  mov R1, [BP+3]
  ieq R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_2176:
  jf R0, __if_2171_end
__if_2180_start:
  mov R0, [BP+3]
  ieq R0, 0
...
__if_2215_start:
  ...
  mov R1, 2
  ieq R1, R0
  jt R1, __switch_2226_case_2
  mov R1, 3
  ieq R1, R0
  jt R1, __switch_2226_case_3
  mov R1, 4
  ieq R1, R0
  jt R1, __switch_2226_case_4
  mov R1, 5
  ieq R1, R0
  jt R1, __switch_2226_case_5
  mov R1, 6
  ieq R1, R0
  jt R1, __switch_2226_case_6
  jmp __switch_2226_end
__switch_2226_case_2:
  mov R2, [BP-1]
  fmul R2, 3.141593
  fdiv R2, 2.000000
  mov [SP], R2
...
__function_textfont_get_line_width:
  ...
  mov [BP-1], R0
__while_2363_start:
__while_2363_continue:
  mov R0, [BP+3]
  mov R0, [R0]
  cib R0
  jf R0, __LogicalAnd_ShortCircuit_2367
  mov R1, [BP+3]
  mov R1, [R1]
  ine R1, 10
  and R0, R1
__LogicalAnd_ShortCircuit_2367:
  jf R0, __while_2363_end
__if_2374_start:
  mov R0, [BP-1]
  ine R0, 0
  jf R0, __if_2374_end
...
__function_textfont_print_line_from_left:
  ...
  mov [BP-1], R0
__while_2400_start:
__while_2400_continue:
  mov R0, [BP+5]
  mov R0, [R0]
  cib R0
  jf R0, __LogicalAnd_ShortCircuit_2404
  mov R1, [BP+5]
  mov R1, [R1]
  ine R1, 10
  and R0, R1
__LogicalAnd_ShortCircuit_2404:
  jf R0, __while_2400_end
  mov R2, [BP+2]
  iadd R2, 1
  mov R1, [R2]
  mov R2, [BP+5]
...
__function_textfont_print_from_left:
  ...
  call __function_select_texture
__while_2443_start:
__while_2443_continue:
  mov R0, [BP+5]
  mov R0, [R0]
  cib R0
  jf R0, __while_2443_end
  mov R1, [BP+2]
  mov [SP], R1
  mov R1, [BP+3]
  mov [SP+1], R1
...
__function_textfont_print_from_right:
  ...
  call __function_select_texture
__while_2479_start:
__while_2479_continue:
  mov R0, [BP+5]
  mov R0, [R0]
  cib R0
  jf R0, __while_2479_end
  mov R1, [BP+2]
  mov [SP], R1
  mov R1, [BP+5]
  mov [SP+1], R1
...
__function_textfont_print_centered:
  ...
  call __function_select_texture
__while_2527_start:
__while_2527_continue:
  mov R0, [BP+5]
  mov R0, [R0]
  cib R0
  jf R0, __while_2527_end
  mov R1, [BP+2]
  mov [SP], R1
  mov R1, [BP+5]
  mov [SP+1], R1
...
__if_5964_start:
  ...
  fgt R0, 2.000000
  jf R0, __LogicalAnd_ShortCircuit_5969
  mov R1, [global_intro_color_from_black]
  flt R1, 1.000000
  and R0, R1
__LogicalAnd_ShortCircuit_5969:
  jf R0, __if_5964_end
...
__if_6039_end:
  ...
  mov R1, 10
  mov [SP+2], R1
  mov R1, __literal_string_6066
  mov [SP+3], R1
  call __function_textfont_print_from_right
__if_6067_start:
  mov R0, [global_info_open]
  jf R0, __LogicalAnd_ShortCircuit_6069
  mov R1, [global_info_offset]
  flt R1, 1.000000
  and R0, R1
__LogicalAnd_ShortCircuit_6069:
  jf R0, __if_6067_end
  mov R0, [global_info_offset]
  fadd R0, 0.020000
  mov [global_info_offset], R0
...
__if_6076_start:
  mov R0, [global_info_open]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_6079
  mov R1, [global_info_offset]
  fgt R1, 0.000000
  and R0, R1
__LogicalAnd_ShortCircuit_6079:
  jf R0, __if_6076_end
  mov R0, [global_info_offset]
  fsub R0, 0.020000
  mov [global_info_offset], R0
...
__if_6093_end:
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6495
  mov [SP+3], R1
  call __function_textfont_print_from_left
  mov R0, [global_effect]
  mov R1, 0
  ieq R1, R0
  jt R1, __switch_6496_case_0
  mov R1, 1
  ieq R1, R0
  jt R1, __switch_6496_case_1
  mov R1, 2
  ieq R1, R0
  jt R1, __switch_6496_case_2
  mov R1, 3
  ieq R1, R0
  jt R1, __switch_6496_case_3
  mov R1, 4
  ieq R1, R0
  jt R1, __switch_6496_case_4
  mov R1, 5
  ieq R1, R0
  jt R1, __switch_6496_case_5
  mov R1, 6
  ieq R1, R0
  jt R1, __switch_6496_case_6
  mov R1, 7
  ieq R1, R0
  jt R1, __switch_6496_case_7
  mov R1, 8
  ieq R1, R0
  jt R1, __switch_6496_case_8
  mov R1, 9
  ieq R1, R0
  jt R1, __switch_6496_case_9
  mov R1, 10
  ieq R1, R0
  jt R1, __switch_6496_case_10
  mov R1, 11
  ieq R1, R0
  jt R1, __switch_6496_case_11
  mov R1, 12
  ieq R1, R0
  jt R1, __switch_6496_case_12
  mov R1, 13
  ieq R1, R0
  jt R1, __switch_6496_case_13
  mov R1, 14
  ieq R1, R0
  jt R1, __switch_6496_case_14
  mov R1, 15
  ieq R1, R0
  jt R1, __switch_6496_case_15
  jmp __switch_6496_end
__switch_6496_case_0:
  mov R0, 160
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6528
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_1:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6560
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_2:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6592
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_3:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6624
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_4:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6656
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_5:
  mov R0, 210
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6688
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_6:
  mov R0, 230
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6720
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_7:
  mov R0, 200
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6752
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_8:
  mov R0, 120
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+1], R1
  mov R1, __literal_string_6770
  mov [SP+2], R1
  call __function_print_at
  jmp __switch_6496_end
__switch_6496_case_9:
  mov R0, 120
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+1], R1
  mov R1, __literal_string_6788
  mov [SP+2], R1
  call __function_print_at
  jmp __switch_6496_end
__switch_6496_case_10:
  mov R0, 140
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+1], R1
  mov R1, __literal_string_6806
  mov [SP+2], R1
  call __function_print_at
  jmp __switch_6496_end
__switch_6496_case_11:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6838
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_12:
  mov R0, 150
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6870
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_13:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6902
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_14:
  mov R0, 200
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
  ...
  mov R1, [BP-2]
  mov [SP+2], R1
  mov R1, __literal_string_6934
  mov [SP+3], R1
  call __function_textfont_print_from_left
  jmp __switch_6496_end
__switch_6496_case_15:
  mov R0, 160
  mov [global_info_size], R0
  mov R2, [global_info_offset]
  mov [SP], R2
...
__while_7008_start:
__while_7008_continue:
  mov R0, 1
  cib R0
  jf R0, __while_7008_end
...
__if_7025_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_7031
  mov R2, [global_info_open]
  bnot R2
  and R1, R2
__LogicalAnd_ShortCircuit_7031:
  mov R0, R1
  jf R0, __if_7025_else
  mov R0, 1
  mov [global_info_open], R0
  jmp __if_7025_end
__if_7025_else:
__if_7035_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_7040
  mov R2, [global_info_open]
  and R1, R2
__LogicalAnd_ShortCircuit_7040:
  mov R0, R1
  jf R0, __if_7035_end
  mov R0, 0
  mov [global_info_open], R0
...
__if_7044_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_7049
  mov R2, [global_effect]
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_7049:
  mov R0, R1
  jf R0, __if_7044_end
  mov R0, [global_effect]
  mov R1, R0
...
__if_7058_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_7063
  mov R2, [global_effect]
  ilt R2, 15
  and R1, R2
...
__if_7075_end:
  ...
  mov R1, 0
  ieq R1, R0
  jt R1, __switch_7108_case_0
  mov R1, 1
  ieq R1, R0
  jt R1, __switch_7108_case_1
  mov R1, 2
  ieq R1, R0
  jt R1, __switch_7108_case_2
  mov R1, 3
  ieq R1, R0
  jt R1, __switch_7108_case_3
  mov R1, 4
  ieq R1, R0
  jt R1, __switch_7108_case_4
  mov R1, 5
  ieq R1, R0
  jt R1, __switch_7108_case_5
  mov R1, 6
  ieq R1, R0
  jt R1, __switch_7108_case_6
  mov R1, 7
  ieq R1, R0
  jt R1, __switch_7108_case_7
  mov R1, 8
  ieq R1, R0
  jt R1, __switch_7108_case_8
  mov R1, 9
  ieq R1, R0
  jt R1, __switch_7108_case_9
  mov R1, 10
  ieq R1, R0
  jt R1, __switch_7108_case_10
  mov R1, 11
  ieq R1, R0
  jt R1, __switch_7108_case_11
  mov R1, 12
  ieq R1, R0
  jt R1, __switch_7108_case_12
  mov R1, 13
  ieq R1, R0
  jt R1, __switch_7108_case_13
  mov R1, 14
  ieq R1, R0
  jt R1, __switch_7108_case_14
  mov R1, 15
  ieq R1, R0
  jt R1, __switch_7108_case_15
  jmp __switch_7108_end
__switch_7108_case_0:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_offset
  jmp __switch_7108_end
__switch_7108_case_1:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_simple_ease
  jmp __switch_7108_end
__switch_7108_case_2:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_different_ease
  jmp __switch_7108_end
__switch_7108_case_3:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_two_axis_ease
  jmp __switch_7108_end
__switch_7108_case_4:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_time_offset
  jmp __switch_7108_end
__switch_7108_case_5:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_follow_by_offset
  jmp __switch_7108_end
__switch_7108_case_6:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_only_one_offset
  jmp __switch_7108_end
__switch_7108_case_7:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_concatenate
  jmp __switch_7108_end
__switch_7108_case_8:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_scale
  jmp __switch_7108_end
__switch_7108_case_9:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_rotation
  jmp __switch_7108_end
__switch_7108_case_10:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_rotozoomed
  jmp __switch_7108_end
__switch_7108_case_11:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_none
  jmp __switch_7108_end
__switch_7108_case_12:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_dual_none
  jmp __switch_7108_end
__switch_7108_case_13:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_speed
  jmp __switch_7108_end
__switch_7108_case_14:
  mov R1, [global_timer]
  mov [SP], R1
  call __function_effect_multiple_speed
  jmp __switch_7108_end
__switch_7108_case_15:
  mov R1, [global_timer]
  mov [SP], R1
